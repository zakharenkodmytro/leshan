...
public class CoapRequestBuilder implements DownlinkRequestVisitor2 {
    ...
    private LowerLayerSetter lowerLayerSetter;
    ...
    public void visit(ReadRequest request) {
        ...
        applyLowerLayerParameters(coapRequest);
    }
    ...
    protected void applyLowerLayerParameters(Request coapRequest) {
        if (lowerLayerSetter != null)
            lowerLayerSetter.applySetting(coapRequest);
    }
